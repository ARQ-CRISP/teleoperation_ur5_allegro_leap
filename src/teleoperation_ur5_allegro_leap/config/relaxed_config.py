...
joint_names = [arm_joints + ['mount_allegro']] 
...
ee_fixed_joints = ['mount_allegro'] #+ [finger[-1] for finger in finger_joints]
...
# starting_config = [-0.27143360527017624, -0.5956459671206638, 0.9211149660325875, -0.054035393641748364, 1.13725654059958, -2.43787589918584]
...
collision_file_name = 'collision_ur5+Allegro.yaml'
###########################################################################################################
...
config_file_name = 'relaxedIK_UR5+Allegro_Nofingers_new.config'
######################################################################################################
